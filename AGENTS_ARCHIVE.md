...
- [x] Dead-code cleanup slice from roadmap: removed orphaned module `phaser/src/Systems/MatchResultSystem.ts` (no imports/usages), removed duplicate `initializeVisualizer()` call from `phaser/src/Client/Screens/Battleground/BattlegroundScene.ts`, and validated no phase-system regressions with `src/Core/PhaseSystem/handlers/PhaseHandlers.test.ts` (38/38 passing) (Copilot, 2026-03-24)
...
- [x] Centralized crystal selection scene UI layout and animation constants in `phaser/src/Client/Screens/CrystalSelection/CrystalSelectionScene.ts` (title/font sizes, button widths, pagination styling, display dimensions, animation timings) (Copilot, 2026-03-20)
- [x] Centralized arena login scene layout and styling constants in `phaser/src/Client/Screens/ArenaLobby/ArenaLoginScene.ts` (title position/font, form dimensions, button offsets, modal styling) (Copilot, 2026-03-20)
- [x] Centralized login modal panel and styling constants in `phaser/src/Client/Screens/ArenaLobby/LoginModal.ts` (panel dimensions, colors, strokes, title font, button offsets) (Copilot, 2026-03-20)
...
- [x] Centralized arena lobby scene layout and styling constants in `phaser/src/Client/Screens/ArenaLobby/ArenaLobbyScene.ts` (title/profile/rating font sizes, positioning, button offsets) (Copilot, 2026-03-20)
