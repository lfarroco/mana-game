...
/**
 * Highest unit rank: 1 bronze → 2 silver → 3 gold → 4 platinum. Platinum is
 * the terminal investment (docs/card-design-philosophy.md) — no unit may be
 * upgraded past it, so a platinum unit ignores further upgrade orbs / duplicate
 * cards.
 */
