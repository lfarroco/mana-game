...
const processEffectIO = (
	...
	switch (effect.id) {
		...
		case "haste":
			...
			break;
		case "slow":
			const slowTargets = resolveTargets(env, sourceUnit, effect, triggeringUnit);
			effects.applySlow(
				env,
				sourceUnit,
				slowTargets,
			...
			break;
		case "charge":
			const chargeTargets = resolveTargets(env, sourceUnit, effect, triggeringUnit);
			effects.applyCharge(
				env,
				sourceUnit,
				chargeTargets,
			...
			break;
		case "increase_power":
			const increasePowerTargets = resolveTargets(env, sourceUnit, effect, triggeringUnit);
			...
			break;
		case "decrease_power":
			const decreasePowerTargets = resolveTargets(env, sourceUnit, effect, triggeringUnit);
		...
		case "increase_critical":
			const increaseCriticalTargets = resolveTargets(env, sourceUnit, effect, triggeringUnit);
