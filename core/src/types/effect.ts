...
export type Effect =
	...
	| { id: "increase_power"; amount: number; permanent?: boolean; targets: Targeting }
	| { id: "decrease_power"; amount: number; permanent?: boolean; targets: Targeting }
	| { id: "multiply_power"; multiplier: number; baseMultiplier: number; targets: Targeting }
	| { id: "increase_critical"; amount: number; permanent?: boolean; targets: Targeting }
