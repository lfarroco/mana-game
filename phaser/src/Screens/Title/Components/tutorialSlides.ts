/**
 * Tutorial slide definitions for the Title screen tutorial overlay.
 * Each slide is a factory function returning a Phaser game object.
 * Extracted from TutorialOverlay.ts (pure refactor — no behavior change).
 */
