		...
		if (effect) {
			...
			if (effect === "arcanemissile") {
				...
				this.time.addEvent({
					delay: 1500,
					callback: () => {
						effects.arcaneMissile({ scene: this, source: { x: 200, y: 500 }, target: { x: 800, y: 200 }, onHit: () => { }, colors: [0xff0000, 0x00ff00] });
						effects.arcaneMissile({ scene: this, source: { x: 200, y: 500 }, target: { x: 800, y: 200 }, });
						effects.arcaneMissile({ scene: this, source: { x: 200, y: 500 }, target: { x: 800, y: 200 }, });
						effects.arcaneMissile({ scene: this, source: { x: 200, y: 500 }, target: { x: 800, y: 200 }, });
						effects.arcaneMissile({ scene: this, source: { x: 200, y: 500 }, target: { x: 800, y: 200 }, });
					},
