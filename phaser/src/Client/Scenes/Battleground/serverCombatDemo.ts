import { runCombat } from "Client/Scenes/Battleground/RunCombatCore";
import { createServerCombatEffects } from "Client/Scenes/Battleground/ServerCombatEffects";
import { createMockState } from "@test-utils/serverCombatUtils";
import { FORCE_ID_PLAYER, FORCE_ID_CPU } from "Client/Scenes/Battleground/ServerConstants";
