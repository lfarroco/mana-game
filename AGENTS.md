...
- [game-server.md](docs/game-server.md): Phased plan for the Node multiplayer backend — Phase 1 (session API) implemented; matchmaking, client integration, and durable persistence still pending
