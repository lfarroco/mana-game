...
type RouteParams<RouteMap extends Routes, R extends keyof RouteMap> =
...
export type ScreenManager<RouteMap extends Routes = Routes> = {
	...
	go: <R extends keyof RouteMap>(route: R, params?: RouteParams<RouteMap, R>) => Promise<void>;
...
export type ScreenManagerHooks = {
	 ...
	 */
	beforeTransition?: (from: ScreenModule | null, to: ScreenModule) => void | Promise<void>;
	/**
...
export function createScreenManager<RouteMap extends Routes>(config: {
	...
	async function go<R extends keyof RouteMap>(route: R, params?: RouteParams<RouteMap, R>): Promise<void> {
